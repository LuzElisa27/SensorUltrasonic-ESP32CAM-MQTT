/*
 * Lectura del sensor ultrasonico HC-SRQ4 con el ESP32CAM y MQTT
 * por: Hugo Escalpelo
 * Fecha: 01 Octubre 2021
 * 
 * Este programa lee el sensor ultrasonico con la biblioteca Ultrasonic en su versión 3.0.0
 * se mezcla con el programa ESP32CAM-MQTT-basic del repositorio de Codigo IoT.
 ...
 * HC-SRQ4-VCC----VCC-FTDI
 * HC-SRQ4-GND----GND-FTDI
 * HC-SRQ4-Trig---GPIO15
 * HC-SRQ4-Echo---GPIO14
 */
